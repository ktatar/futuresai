...
Through the organization of three workshops, we produce dfabulations that act as possible trajectories for Nordic care futures, and developed a toolkit and a book for fabulating  compiling reflections on how Fabulation works, what it is good for, and strategies and tactics for developing meaningful shared futures.

**Project Page**

<https://nordicfabulation.net/>


## Acknowledgements

This is a NordForsk-funded [NOS-HS Exploratory Workshop series](https://funding.nordforsk.org/portal/#call/2605/details), titled “Nordic Fabulation Network” (project number 133226).


## Publications
<div class="publications">
{% bibliography --file fabulation_project.bib %}
</div>
